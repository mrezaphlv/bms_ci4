        ...
        <div class="row" style="margin-bottom:1rem;">
            <div class="col-sm-6 mb-2">
                ...
                <div class="input-group">
                    <input type="hidden" class="form-control" value="<?= $dth->id_unit; ?>"  name="id_unit" id="id_unit">
                  <input required value="<?php echo $dth->kode_unit; ?>" type="text" class="form-control" name="unit_show" id="unit_show">
          ...
          <div class="col-sm-6 mb-2">
                ...
                <select class="form-select" id="id_meter" name="id_meter">
                  <option value="">--Pilih Utility--</option>
                  <?php if ($droplist_meterid->status): ?>
                      <?php foreach ($droplist_meterid->data as $key => $ba): ?>
                        <?php
                        $selected = '';
                        if($ba->kode == $dth->kode_meter){
                            $selected = 'selected';
                        }
                        ?>
            ...
            <div class="col-sm-6">
                ...
                <input  type="date" class="form-control" value="<?php echo $dth->periode; ?>" name="periode"  id="periode">
            </div>
            <div class="col-sm-6 mb-2">
                <label for="inputPassword" class="">Start Meter</label>
                <input type="text" class="form-control" value="<?php echo $dth->start_meter; ?>" name="start_meter" id="start_meter">
            </div>
            <div class="col-sm-6 mb-2">
                ...
                <input type="hidden" class="form-control" value="<?= $dth->foto_meter; ?>"  name="foto_file_old" id="foto_file_old">
               
            </div>
            <div class="col-sm-6">
            <?php
            if ($dth->foto_meter !== null) { ?>
                <center><img src="<?php echo base_url('dokumen/utility_record/' . $dth->foto_meter); ?>" style="max-width: 200%; max-height: 300px; margin-top:20px;"></center>
            <?php } else { ?>
                <p>Image not found</p>
            <?php }
            ?>
            ...
            <div class="col-sm-6">
                <label for="inputPassword6" class="col-form-label">Edit Photo</label>
                <div id="drop_zone" style="display: flex; flex-direction: column; align-items: center;">
            ...
            <input  type="hidden" class="form-control" value="<?php echo $dth->id; ?>" name="id"  id="id">
            ...
            <button id="btnUpdateUtilityRecord" type="submit" class="btn btn_warna1 btn_bentuk1">Save</button>
        </div>
    </form>
